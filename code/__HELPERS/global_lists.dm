...
var/global/list/datum/species/rewardlistbase = list(/datum/species/human, /datum/species/lizard,/datum/species/cat, /datum/species/bird, /datum/species/bot, /datum/species/skeleton/alt, /datum/species/jelly, /datum/species/kida)
